          ...
          children: [
            SizedBox(
              ...
              child: _MediaCarousel(
                ...
                imageUrl: widget.contest.titleImageUrl.isNotEmpty ? widget.contest.titleImageUrl : widget.contest.imageUrl,
              ),
            ),
            Container(
              width: double.infinity,
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (widget.contest.imageUrl.isNotEmpty) ...[
