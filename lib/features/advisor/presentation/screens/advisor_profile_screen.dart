                        ...
                        _buildExpandableSection(
                          ...
                          children: [
                            ...
                            _buildInfoRow(
                              context,
                              "Commission Slab",
                              "₹ ${double.tryParse(provider.profile!.slab)!.toStringAsFixed(0)}",
                              Icons.percent,
                              isDark,
                            ),
                            _buildInfoRow(
                            ...
                            _buildInfoRow(
                              context,
                              "Marital Status",
                              provider.profile!.maritalStatus,
                        ...
                        _buildExpandableSection(
                          ...
                          children: [
                            _buildInfoRow(
                              context,
                              "Application No",
                              provider.profile!.applicationNumber,
                            ...
                            _buildInfoRow(
                              context,
                              "Primary Profession",
                              provider.profile!.primaryProfession,
                              Icons.work,
                              isDark,
                            ),
                            _buildInfoRow(
                              context,
                              "Qualification",
                              provider.profile!.qualification,
                            ...
                            _buildInfoRow(
                              context,
                              "Branch Location",
                              provider.profile!.branchLocation,
                        ...
                        _buildExpandableSection(
                          ...
                          children: [
                            ...
                            _buildInfoRow(
                              context,
                              "State",
                              "${provider.profile!.state} - ${provider.profile!.pincode}",
                              Icons.map_outlined,
                              isDark,
                            ),
                            _buildInfoRow(
