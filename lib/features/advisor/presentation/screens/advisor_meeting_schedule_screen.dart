...
class _AdvisorMeetingScheduleScreenState
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<AdvisorAttendanceProvider>().fetchAttendanceHistory(
        advisorCode,
      );
    });
  }
  ...
  Widget _buildHistoryTab(
    AdvisorAttendanceProvider provider,
    Color primaryBlue,
    Color cardColor,
    Color borderColor,
    Color textColor,
      ...
      child: Column(
        ...
        children: [
          ...
          if (history.meetingDetails.isEmpty)
            ...
            ...history.meetingDetails.map(
              (detail) => _buildHistoryDetailCard(
                detail,
                primaryBlue,
                cardColor,
                borderColor,
  ...
  Widget _buildHistoryDetailCard(
    AdvisorAttendanceDetail detail,
    Color primaryBlue,
    Color cardColor,
    Color borderColor,
    Color textColor,
                        ...
                        children: [
                          ...
                          Text(
                            detail.checkInTime != null
                                ? _formatTime(detail.checkInTime!)
                                : '--:--',
                            style: GoogleFonts.montserrat(
                              fontSize: 13,
                              fontWeight: FontWeight.bold,
                        ...
                        children: [
                          ...
                          Text(
                            detail.checkOutTime != null
                                ? _formatTime(detail.checkOutTime!)
                                : '--:--',
                            style: GoogleFonts.montserrat(
                              fontSize: 13,
                              fontWeight: FontWeight.bold,
  ...
  Widget _buildMeetingCard(
    ...
    bool isCompleted =
        meeting.checkOutTime != null || meeting.status == 'completed';
            ...
            children: [
              ...
              Builder(
                builder: (context) {
                  ...
                  try {
                    if (meeting.meetingDate.isNotEmpty &&
                        meeting.startTime.isNotEmpty &&
                        meeting.startTime != '--:--') {
                    ...
                    if (meeting.meetingDate.isNotEmpty &&
                        meeting.endTime.isNotEmpty &&
                        meeting.endTime != '--:--') {
                      endDateTime = DateTime.parse(
                        '${meeting.meetingDate} ${meeting.endTime}',
                      );
                    }
                  } catch (_) {}
                  ...
                  if (meeting.checkInTime == null &&
                    ...
                    if (startDateTime != null) {
                      ...
                      DateTime earliestCheckIn = startDateTime.subtract(
