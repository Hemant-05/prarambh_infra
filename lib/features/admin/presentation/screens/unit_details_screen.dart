...
class UnitDetailsScreen extends StatelessWidget {
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Stack(
                fit: StackFit.expand,
                children: [
                  Image.asset('assets/images/logos.png', fit: BoxFit.cover), // Replace with unit image
                  ...
                  Positioned(bottom: 12, right: 12, child: Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4), decoration: BoxDecoration(color: Colors.black54, borderRadius: BorderRadius.circular(12)), child: Text('1/8', style: GoogleFonts.montserrat(color: Colors.white, fontSize: 12)))),
                ],
              ),
            ),
          ),
  ...
  Widget _buildSpecBox(IconData icon, String title, String value, Color cardColor) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12), decoration: BoxDecoration(color: cardColor, borderRadius: BorderRadius.circular(12), border: Border.all(color: Colors.grey.withOpacity(0.2))),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Row(children: [Icon(icon, size: 14, color: Colors.blue[800]), const SizedBox(width: 6), Text(title, style: GoogleFonts.montserrat(fontSize: 10, color: Colors.grey))]),
